...
import team.hdt.hrag.utils.State;
...
public class Display {
	...
	private HashMap<Integer, State> keyStates = new HashMap<>();
	...
	public boolean create() {
		...
		window = GLFW.glfwCreateWindow((isFullScreen ? videoMode.width() : width),
				(isFullScreen ? videoMode.height() : height), title, (isFullScreen ? GLFW.glfwGetPrimaryMonitor() : 0),
				window);
		if (isFullScreen) {
